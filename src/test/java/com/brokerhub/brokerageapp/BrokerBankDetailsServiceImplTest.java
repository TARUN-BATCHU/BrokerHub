...
//
//class BrokerBankDetailsServiceImplTest {
//
//    @Mock
//    private BrokerBankDetailsRepository brokerBankDetailsRepository;
//
//    @InjectMocks
//    private BrokerBankDetailsServiceImpl bankDetailsServiceImpl;
//
//    @BeforeEach
//    void setUp() {
...
//
//        when(brokerBankDetailsRepository.findByAccountNumber("123456789")).thenReturn(null);
//
...
//        verify(brokerBankDetailsRepository, times(1)).save(bankDetails);
//    }
//
//    @Test
...
//        bankDetails.setAccountNumber("123456789");
//
//        when(brokerBankDetailsRepository.findByAccountNumber("123456789")).thenReturn(bankDetails);
//
//        ResponseEntity<String> response = bankDetailsServiceImpl.createBankDetails(bankDetails);
//
...
//        verify(brokerBankDetailsRepository, never()).save(bankDetails);
//    }
//
//    @Test
